# -*- coding: utf-8 -*-
# Instagram初投稿用 1080x1350＝縦5:横4（OGP/Xヘッダーと同じトーン。
...
# 淡い光の円（スマホの背面）
d.ellipse([540 - 390, 930 - 390, 540 + 390, 930 + 390], fill=(238, 248, 243))
...
sparkle(860, 550, 44, ORANGE)
sparkle(215, 600, 30, GREEN)
sparkle(890, 1170, 30, GREEN)
d.ellipse([950, 545, 974, 569], fill=ORANGE)
...
# グラフ
d.rounded_rectangle([394, 1122, 686, 1270], radius=16, fill=(246, 250, 249), outline=BORDER, width=3)
pts = [(420, 1164), (472, 1140), (524, 1152), (576, 1132), (628, 1146), (664, 1128)]
d.line(pts, fill=GREEN, width=8, joint="curve")
for p2 in pts:
    d.ellipse([p2[0] - 7, p2[1] - 7, p2[0] + 7, p2[1] + 7], fill=GREEN)

# 左下: ドメイン
d.text((60, 1290), "majasco.jp", font=font(34, 700), fill=(154, 168, 164), anchor="lm")
